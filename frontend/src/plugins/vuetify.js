...
import LayoutAsideMain from '@/assets/icons/layout-aside-main.svg'
import LayoutMainAside from '@/assets/icons/layout-main-aside.svg'
    ...
    const opts = {
      ...
      icons: {
        values: {
          ...
          layoutAsideMain: { component: LayoutAsideMain },
          layoutMainAside: { component: LayoutMainAside },
        },
      },
      theme: {
        themes: {
