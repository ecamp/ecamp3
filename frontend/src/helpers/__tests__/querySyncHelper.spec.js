import { processRouteQuery, transformQueryParam } from '@/helpers/querySyncHelper'
...
describe('querySyncHelper', () => {
  ...
  describe('idToHalUri', () => {
    it.each([
      ...
      [["activity_progress_labels","456sfs56sus"],"/activity_progress_labels/456sfs56sus"],
  ...
  describe('transformQueryParam', () => {
    it.each([
      [ ['responsible',["73558f9c6483","fe6557a4b89f"],'camp_collaborations'], ['responsible',["/camp_collaborations/73558f9c6483","/camp_collaborations/fe6557a4b89f"]] ],
      [ ['period',"73558f9c6483",'periods'], ['period',"/periods/73558f9c6483"] ],
      [ ['category',["73558f9c6483","fe6557a4b89f"],'categories'], ['category',["/categories/73558f9c6483","/categories/fe6557a4b89f"]] ],
      [ ['progressLabels',["73558f9c6483","fe6557a4b89f"],'activity_progress_labels'], ['progressLabels',["/activity_progress_labels/73558f9c6483","/activity_progress_labels/fe6557a4b89f"]] ],
      [ ['responsible',["73558f9c6483","fe6557a4b89f"],'camp_collaborations'], ['responsible',["/camp_collaborations/73558f9c6483","/camp_collaborations/fe6557a4b89f"]] ],
      [ ['category',["73558f9c6483","fe6557a4b89f"],'categories'], ['category',["/categories/73558f9c6483","/categories/fe6557a4b89f"]] ],
      [ ['progressLabels',["73558f9c6483","fe6557a4b89f"],'activity_progress_labels'], ['progressLabels',["/activity_progress_labels/73558f9c6483","/activity_progress_labels/fe6557a4b89f"]] ],
      [ ['responsible',["73558f9c6483","fe6557a4b89f"],'camp_collaborations'], ['responsible',["/camp_collaborations/73558f9c6483","/camp_collaborations/fe6557a4b89f"]] ],
      [ ['period',"fe6557a4b89f",'periods'], ['period',"/periods/fe6557a4b89f"] ],
      [ ['responsible',null,'camp_collaborations'], ['responsible',null] ],
    ])('should transform %p to %p', (input, expected) => {
  ...
  describe('processRouteQuery', () => {
    it.each([
      ...
      [ {
        ...
        category: ["/categories/505e3fdf9e90","/categories/a47a60594096"],
        responsible: ["/camp_collaborations/3a5azag84","/camp_collaborations/a5aaf4a5","/camp_collaborations/5asd5as5","/camp_collaborations/ad45a45ag"]
      } ],
    ])('should transform %p to %p', (input, expected) => {
