...
(function(){
    ...
    var module = angular.module('ecamp.camp.event.event-controller', []);

    module.directive('eventPlugins', [function(){
        return {
            restrict: 'E',
    ...
    module.directive('linearPluginContainer', [function(){
        return {
            restrict: 'E',
            scope: true,
    ...
    module.directive('linearPluginContainerItem', [function(){
        return {
            restrict: 'EA',
    ...
    module.directive('tabbedPluginContainer', [function(){
        return {
            restrict: 'E',
            scope: true,
    ...
    module.directive('tabbedPluginContainerItem', [function(){
        return {
            restrict: 'EA',
