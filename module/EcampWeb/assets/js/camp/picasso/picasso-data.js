...
(function(){
    ...
    var module = angular.module('ecamp.picasso.data', [
        'ecamp.SortedDictionary',
        'ecamp.apiV0'
    ]);

    module.factory('PicassoData', ['ecampApiV0', 'SortedDictionary',

        function(ecampApiV0, SortedDictionary){
            ...
            function PicassoData(cfg){
                ...
                function PicassoPeriodUpdate(period, data){
                    period.start = new Date(data.start);
                    return period;
                }
                /** @returns {number} */
