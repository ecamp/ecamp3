...
(function() {
    var module = angular.module('ecamp.RemoteData', ['angular-hal']);

    module.factory('RemoteResource', ['$timeout', 'halClient',
        function ($timeout, halClient) {
    ...
    module.factory('RemoteCollection', ['$timeout', '$q', 'halClient', 'RemoteResource',
        function ($timeout, $q, halClient, RemoteResource) {
    ...
    module.factory('RemoteCreateResource', ['$timeout', '$q', 'halClient',
        function ($timeout, $q, halClient) {
    ...
    module.directive('remoteResource', ['RemoteResource',
    ...
    module.directive('remoteCollection', ['RemoteCollection',
    ...
    module.directive('remoteCreateResource', ['RemoteCreateResource',
        function (RemoteCreateResource) {
            return {
                restrict: 'EA',
                scope: false,
