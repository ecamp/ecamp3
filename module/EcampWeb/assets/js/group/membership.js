...
(function(){
    ...
    var module = angular.module('ecamp-membership', [
        'ui.bootstrap',
        'angular-hal'
    ]);

    module.directive('groupMembership', [function(){
        return {
            restrict: 'E',
            scope: true,
    ...
    module.directive('groupMembershipDescription', [function(){
        return {
            restrict: 'E',
    ...
    module.directive('groupMembershipOperation', [function(){
        return {
            restrict: 'E',
            templateUrl: '/web-assets/tpl/group/membership/operation.html',
            scope: false,
            link: function($scope, $element, $attrs, $ctrl) {
                $element.css({ 'display': 'inline' });
