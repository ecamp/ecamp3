...
namespace EcampLib\Validator;

use DoctrineORMModule\Form\Annotation\AnnotationBuilder;
use Zend\ServiceManager\AbstractFactoryInterface;
use Zend\ServiceManager\ServiceLocatorInterface;

class EntityValidatorFactory implements AbstractFactoryInterface
{
    ...
    public function createServiceWithName(ServiceLocatorInterface $formElementManager, $name, $requestedName)
    {
        ...
        return $formSpec->getInputFilter()->get($elementName)->getValidatorChain();
    }
