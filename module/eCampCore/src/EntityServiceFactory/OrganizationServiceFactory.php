...
use eCamp\Core\EntityService\OrganizationService;
...
final class OrganizationServiceFactory implements FactoryInterface {
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
        ...
        $proxy = $proxyFactory->createProxy(OrganizationService::class, $initializer);
