...
use eCamp\Core\EntityService\JobService;
...
final class JobServiceFactory implements FactoryInterface {
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
        ...
        $proxy = $proxyFactory->createProxy(JobService::class, $initializer);
