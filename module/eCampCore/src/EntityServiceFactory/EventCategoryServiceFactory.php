...
use eCamp\Core\EntityService\EventCategoryService;
...
final class EventCategoryServiceFactory implements FactoryInterface {
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
        ...
        $proxy = $proxyFactory->createProxy(EventCategoryService::class, $initializer);
