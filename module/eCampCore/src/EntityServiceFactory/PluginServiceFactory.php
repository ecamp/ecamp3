...
use eCamp\Core\EntityService\PluginService;
...
final class PluginServiceFactory implements FactoryInterface {
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
        ...
        $proxy = $proxyFactory->createProxy(PluginService::class, $initializer);
