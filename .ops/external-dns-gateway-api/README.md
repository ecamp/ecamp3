...
Authentication for the DNS provider (e.g., `API_TOKEN`) should be provided via environment variables or secrets, which are merged into `env.yaml` during the deployment process.
