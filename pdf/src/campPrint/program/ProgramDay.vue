  ...
  <View class="program-day-summary">
    ...
    <View class="program-day-table">
      ...
      >
        ...
        <View class="program-day-table-activity">
          <CategoryLabel
...
export default {
  name: 'ProgramDay',
  components: { CategoryLabel, Responsibles, ScheduleEntry },
  ...
  methods: {
    rangeTime(scheduleEntry) {
      return `${this.$date.utc(scheduleEntry.start).format('HH:mm')} - ${this.$date
        .utc(scheduleEntry.end)
        .format('HH:mm')}`
    },
  },
}
