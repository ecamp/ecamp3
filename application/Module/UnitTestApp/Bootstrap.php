...
class UnitTestApp_Bootstrap extends Zend_Application_Module_Bootstrap
{
	...
	protected function _initAutoloader()
	{
		...
		$navigationAutoloader = new \Doctrine\Common\ClassLoader('UnitTestApp', APPLICATION_PATH . '/Module/');
		$autoloader->pushAutoloader(array($navigationAutoloader, 'loadClass'), 'UnitTestApp');
	}
	...
	public function _routeShutdown_ErrorHandler()
	{
		...
		$plugin->setErrorHandlerModule('UnitTestApp');
