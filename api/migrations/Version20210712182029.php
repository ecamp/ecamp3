...
final class Version20210712182029 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('CREATE TABLE content_node (id VARCHAR(16) NOT NULL, slot TEXT DEFAULT NULL, position INT DEFAULT NULL, jsonConfig JSON DEFAULT NULL, instanceName TEXT DEFAULT NULL, createTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updateTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, rootId VARCHAR(16) DEFAULT NULL, parentId VARCHAR(16) DEFAULT NULL, contentTypeId VARCHAR(16) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE content_type (id VARCHAR(16) NOT NULL, name VARCHAR(32) NOT NULL, active BOOLEAN NOT NULL, strategyClass TEXT NOT NULL, jsonConfig JSON DEFAULT NULL, createTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updateTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE content_type_singletext (id VARCHAR(16) NOT NULL, text TEXT DEFAULT NULL, createTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updateTime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void {
        ...
        $this->addSql('ALTER TABLE material_item DROP CONSTRAINT FK_4B73482B6F35AAFF');
