...
router.use('/pdfChrome', async (req, res) => {
  ...
  try {
    ...
    const pdf = await page.pdf({
      ...
      headerTemplate: `<div id="header-template" style="font-size:7pt; text-align: center; width: 100%; font-family: Helvetica, sans-serif; font-weight: 300; color: #bbb"><span>eCamp3 Beta</span></div>`,
      footerTemplate: `<div id="footer-template" style="font-size:8pt; text-align: center; width: 100%; font-family: Helvetica, sans-serif; font-weight: 600"><span class="pageNumber"></span> / <span class="totalPages"></span></div>`,
      margin: {
        bottom: '15mm',
        left: '15mm',
        right: '15mm',
