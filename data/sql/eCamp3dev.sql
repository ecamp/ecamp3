...
CREATE TABLE `event_resps` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `userCamp_id` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `logins` VALUES ('9a6af61','14fcb010','2012-09-14 21:32:17','2012-09-14 21:32:17','f4ad2ca02b533790d71040635b2d6973a363134fdb8967d021e437c9c0c88d75','be8a6d0e2add5b1f5bb390c8c55e02a313b37518d3c3eabaa85c6aae3d8b62ef',NULL);
